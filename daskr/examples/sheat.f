...
C
      ...
      EXTERNAL RESH, RTHEAT, SBANJA, SBANPS
...
C LOUT is the unit number of the output device.
 ...
 30   FORMAT(' SHEAT: Heat Equation Example Program for SDASKR'//
...
C
C We pass to SDASKR the names SBANJA and SBANPS for the JAC and PSOL
